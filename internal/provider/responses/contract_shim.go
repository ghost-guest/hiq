...
// hiq adaptation notes (vs upstream Reasonix):
//
...
// provider.LookupOfficialOpenCodeGo). hiq ships without that catalog, and
...
// officialOutputLimit always misses: hiq has no static per-model catalog,
