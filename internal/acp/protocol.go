...
// to drive hiq. Many tools integrated with the v1 (main-branch) agent over
...
// older map shape that hiq v1 clients used.
...
// SessionListResult is the first and only page of sessions hiq currently
