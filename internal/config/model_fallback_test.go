...
func testModelFallbackConfig(t *testing.T) *Config {
	...
	c.Providers = []ProviderEntry{
		...
		{Name: "prov-b", Kind: "openai", BaseURL: "https://b.example.com", Model: "model-b1", Models: []string{"model-b1", "model-b2"}, APIKeyEnv: "HIQ_TEST_KEY"},
		{Name: "prov-nokey", Kind: "openai", BaseURL: "https://nk.example.com", Model: "model-nk", APIKeyEnv: "HIQ_TEST_EMPTY"},
	}
	return c
}
...
func TestResolveModelWithFallbackSkipsKeylessProvider(t *testing.T) {
	...
	c.Providers[0].APIKeyEnv = "HIQ_TEST_EMPTY"
...
func TestResolveModelWithFallbackHonorsDefaultModel(t *testing.T) {
	...
	c.Providers[1].APIKeyEnv = "HIQ_TEST_EMPTY" // prov-b, the DefaultModel
...
func TestRemoveProviderBlocksDefaultWithoutFallback(t *testing.T) {
	...
	c.Providers[1].APIKeyEnv = "HIQ_TEST_EMPTY"
