...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "HIQ_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "HIQ_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "HIQ_TEST_MISSING"}, false},
