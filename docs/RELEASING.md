...
How hiq ships, who can ship what, and the canary-before-stable flow.
...
|---|---|---|
| npm | `latest` (0.x), `next` (1.x) | `canary` (`npm i hiq@canary`) |
...
3. **Test** — testers install `hiq@canary` (CLI) or grab the desktop canary
