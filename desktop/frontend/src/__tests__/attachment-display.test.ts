...
const named = parseAttachmentRefsForDisplay(
  "review @[DS30000.sl2](.hiq/attachments/clipboard-20260610-121238.444775-000002.sl2) and @[park.png](.hiq/attachments/clipboard-20260610-121238.444775-000001.png)",
);
...
eq(
  ...
  [
    {
      path: ".hiq/attachments/clipboard-20260610-121238.444775-000002.sl2",
      name: "DS30000.sl2",
      kind: "file",
      ext: "SL2",
    },
    {
      path: ".hiq/attachments/clipboard-20260610-121238.444775-000001.png",
      name: "park.png",
      kind: "image",
      ext: "PNG",
    },
...
eq(
  replaceAttachmentRefsForDisplay("see @[DS30000.sl2](.hiq/attachments/clipboard-20260610-121238.444775-000002.sl2)"),
